...
# Created by write_sdc on Fri Oct 10 16:42:59 2025
...
create_clock [get_ports UART_CLK]  -period 271.29  -waveform {0 135.645}
...
create_generated_clock [get_pins UART_RX_CLK_U0/o_div_clk]  -name RX_CLK  -source [get_ports UART_CLK]  -master_clock UART_CLK  -divide_by 1  -add
set_clock_uncertainty -setup 0.2  [get_clocks RX_CLK]
set_clock_uncertainty -hold 0.1  [get_clocks RX_CLK]
create_generated_clock [get_pins UART_TX_CLK_U0/o_div_clk]  -name TX_CLK  -source [get_ports UART_CLK]  -master_clock UART_CLK  -divide_by 32  -add
set_clock_uncertainty -setup 0.2  [get_clocks TX_CLK]
set_clock_uncertainty -hold 0.1  [get_clocks TX_CLK]
create_clock [get_ports scan_clk]  -period 1000  -waveform {0 500}
...
set_input_delay -clock RX_CLK  54.258  [get_ports UART_RX_IN]
...
set_output_delay -clock RX_CLK  54.258  [get_ports parity_error]
set_output_delay -clock RX_CLK  54.258  [get_ports framing_error]
set_output_delay -clock TX_CLK  54.258  [get_ports UART_TX_O]
